...
public class EmailService {
	...
	public String templateToHtml(ByteArrayOutputStream xmlSource, String templateName) throws TransformerException {
	  ...
	  public void sendMail(String to, String cc, String from, String fromName, String subject, String htmlContent) throws AddressException, MessagingException, UnsupportedEncodingException
	   {
	      ...
	      Session session = null;
		      ...
		      session = Session.getDefaultInstance(properties,  
		    		   ...
		    		   protected PasswordAuthentication getPasswordAuthentication() {
		    			   //System.out.println(" -- " + NVOProperties.getInstance().getEmailFromFordPassword());
	    ...
	    //  try{
	       ...
	       //  message.setFrom(new InternetAddress(NVOProperties.getInstance().getEmailFrom()));
	       ...
	       //setting reply to for nvo help link 1469
	         ...
	         /*message.addRecipient(Message.RecipientType.CC,
		        ...
		        /* if(to==Constants.NVO_HELP_EMAIL_TO){
		        		 message.setReplyTo(new javax.mail.Address[] {new InternetAddress(cc, fromName)});
		         }*/
	  ...
	  public void sendMailWithAttachment(String to, String cc, String from, String fromName, String subject, String htmlContent, Map<String,DataSource> attachmentFile) throws AddressException, MessagingException, UnsupportedEncodingException
	   {
		  LOGGER.log(Level.INFO,"Inside EmailService:sendMail");
	      // Get system properties
	      Properties properties = System.getProperties();
